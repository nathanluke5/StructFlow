...
namespace StructFlow.Components.Misc
{
    public class ZipFolder : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (!DA.GetData(2, ref zippath)) return;
            ...
            //if (Primary == null)
            //{
            //    AddRuntimeMessage(GH_RuntimeMessageLevel.Warning, "Input Primary and Secondary Curves");
            //    return;
            //}
            if(go)
            {
